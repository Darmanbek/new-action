import { DeleteOutlined, EditOutlined, EyeFilled, UserOutlined } from "@ant-design/icons"
...
import { type TTeacher, useDeleteTeachersMutation } from "src/services/teachers"
	...
	const columns: ColumnsType<TTeacher> = [
		...
		// },
		{
			...
			render: (group_count: number) => (
				<UiTag color={"red"}>{`${formatEmpty(group_count)} ${groupGrammar(group_count)}`}</UiTag>
			)
		},
		{
			fixed: "right",
