...
import { useGetFinancesCompaniesByIdQuery } from "src/services/finances/finances.api"
...
const TableFinanceCompanies: FC = () => {
	...
	const { data: finance, isLoading, isFetching } = useGetFinancesCompaniesByIdQuery({}, company)
