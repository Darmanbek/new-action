...
import { type TBalanceChange, useCreateBalanceMutation } from "src/services/groups/balance"
import { useGetPaymentTypesQuery } from "src/services/shared/payment-types"
import { formMessage, inputPlaceholder, paymentTranslation, selectPlaceholder } from "src/utils"
				...
				>
					<UiSelect
						options={payments?.data.map((pay) => ({
							value: pay.id,
							label: paymentTranslation(pay.name)
						}))}
