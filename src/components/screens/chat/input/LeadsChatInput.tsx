...
// import { useCreateLeadMessageMutation } from 'src/services/u';
  ...
  return (
    <form name="Chat Form" onSubmit={onFinish} className={s.lead_form}>
      ...
      <span className={s.emoji_item}>
        <Popover
          content={<LeadsEmojiPicker onChange={onChangeEmojiValue} />}
          trigger="click"
        >
          <Avatar
            src={<img className={s.img} src={smile} alt="smile" />}
            size={32}
          />
        </Popover>
      </span>
