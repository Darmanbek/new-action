	...
	return (
		...
		>
			<Typography.Paragraph>
				At NewAction, we prioritize your privacy and are dedicated to protecting
			...
			<Typography.Paragraph>
				...
				<ul>
					<li>
						Group Requests: Allows students to request specific language course
						groups.
					</li>
					<li>
			...
			<Typography.Paragraph>
				Our app provides a chat feature for communication related to educational
			...
			<Typography.Paragraph>
				<ul>
					<li>
						...
						required or necessary for service provision (e.g., technical support
						or hosting services).
					</li>
					<br />
					<li>
					...
					<li>
						...
						purposes
						or as required by law. You may request profile data deletion at any
						time
						by contacting us.
					</li>
				</ul>
