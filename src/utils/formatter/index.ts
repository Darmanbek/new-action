...
export const phoneFormatter = (phone?: string | null) => {
	return phone ? phone.replace(/(\d{3})(\d{2})(\d{3})(\d{2})(\d{2})/, "+$1 $2 $3 $4 $5") : "-"
}
		...
		case "cash":
			return createElement(UiTag, {
				...
				icon: createElement(Icon, {
					children: createElement(TbCashBanknote),
					viewBox: "0 0 14 14"
				})
			})
		case "click":
			return createElement(UiTag, {
				...
				color: "geekblue",
				icon: createElement(Icon, {
					children: createElement(TbSquareRoundedPercentage),
					viewBox: "0 0 14 14"
				})
			})
		case "payme":
			return createElement(UiTag, {
				...
				color: "cyan",
				icon: createElement(Icon, {
					children: createElement(PiContactlessPayment),
					viewBox: "0 0 14 14"
				})
			})
		case "paynet":
