...
import { TResponseSingleData } from "src/services/shared"
import { TAuthLogin, TProfileAuth, TTokenAuth } from "./login.types"

const fetchSignIn = async (value: TAuthLogin): Promise<TResponseSingleData<TTokenAuth>> => {
