...
import { TGetParams, TResponseData, TResponseSingleData } from "src/services/shared"
import { TMessage, TMessageChange, TMessageItem } from "./chat.types"

const axiosGetMessage = async (params: TGetParams): Promise<TResponseData<TMessage>> => {
...
export { axiosGetMessage, axiosGetMessageById, axiosCreateMessage, axiosEditMessage }
