  ...
  return (
    <>
      ...
      <UiCard
        ...
        actions={[
          <Typography.Link href={"mailto:karsoftuz@gmail.com"}>
      ...
      >
        <Typography.Paragraph>
          ...
          explains how we collect, use, protect, and retain your data when you
          use our app.
        </Typography.Paragraph>
        ...
        <Typography.Paragraph>
          ...
          <ul>
            ...
            <li>
              Phone Number: Used for registration, authentication, and
        ...
        <Typography.Paragraph>
          ...
          educational services. Messages you send are stored securely on our
          servers and are only accessible to: <br />
          <br />
          <ul>
            <li>Director</li>
            <li>Administrator</li>
        ...
        <Typography.Paragraph>
          <ul>
            ...
            <li>
              ...
              purposes or as required by law. You may request profile data
